                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('*charts') ? 'class="active"' : '') }}>
                            <a href="{{ url ('charts') }}"><i class="fa fa-bar-chart-o fa-fw"></i> Diagram Laporan</a>
                            <!-- /.nav-second-level -->
                        </li>
                        <li {{ (Request::is('*admins') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admins') }}"><i class="fa fa-table fa-fw"></i> Admin</a>
                        </li>
                        <li {{ (Request::is('*pengguna') ? 'class="active"' : '') }}>
                            <a href="{{ url ('pengguna') }}"><i class="fa fa-table fa-fw"></i> Pengguna</a>
                        </li>
